...
const App: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-gray-50 min-h-screen relative pb-28 shadow-2xl overflow-hidden">
      ...
      <section ref={overviewRef} className="bg-white p-5 pb-4 rounded-b-2xl shadow-sm mb-3">
        <div className="flex justify-between items-start mb-2">
          <div className="flex-1 mr-2">
             <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
                <span className="text-sm text-gray-500 font-medium">MOP</span>
                <span className="text-3xl font-bold text-slate-900 tracking-tight leading-none">490,000</span>
      ...
      {/* Sticky Footer - Optimized for touch and safety area */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 pt-3 pb-6 flex items-center justify-between z-50 max-w-md mx-auto shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
         ...
         <div className="flex gap-3 ml-2 flex-1">
             ...
             <button className="flex-1 bg-emerald-700 text-white text-sm font-bold py-2.5 rounded-lg shadow-lg shadow-emerald-200 active:scale-95 transition-transform">
                 立即出價
             </button>
         </div>
      </div>
